...
import DatabaseInfoForm from '../../form/standard/DatabaseInfoForm';
type propTypes = {
    details: any;
    width: number;
    isEditable: boolean;
...
class DatabaseInfoDialog extends Component<propTypes> {
    ...
    render() {
        ...
        const WrappedForm = Form.create()(DatabaseInfoForm);
        return (
            <Modal
