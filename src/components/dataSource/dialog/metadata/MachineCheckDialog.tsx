...
// @ts-ignore
import Machine from '../../center/submodule/metadata/Machine';
        ...
        return (
            ...
            >
                <LocaleProvider locale={zh_CN}>
                    <Machine height={500} width={width} isAction={true} changeSelectedKeys={this.changeSelectedKeys} selectedRowKeys={selectedRowKeys}/>
                </LocaleProvider>
            </Modal>
        );
    }
